...
const cli = meow(`
	What it does:
	  ...
	  - List all outdated branches (unless you --skip-outdated)
	...
	Examples
	  ...
	  $ git-keeper -riS    # Interactively choose remote branches to remove 
...
Git.Repository.open(process.cwd()).then(repository => {
    keeper(cli.flags, repository).then(results => {
